...
export default function ParallaxBackground() {
  ...
  return <ParallaxLayers container={container} />;
}

function ParallaxLayers({ container }: { container: HTMLElement }) {
  ...
  return (
    <div className="fixed inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }}>
      {/* Layer 1 — Rings + lines */}
      <motion.div style={{ y: y1, opacity: opacity1, scale: scale1 }} className="absolute inset-0 will-change-transform">
        <svg viewBox="0 0 1440 900" fill="none" className="w-full h-full" preserveAspectRatio="xMidYMid slice">
          ...
          <defs>
            <linearGradient id="ring1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stopColor="#6366f1" /><stop offset="100%" stopColor="#a855f7" /></linearGradient>
            <linearGradient id="ring2" x1="100%" y1="0%" x2="0%" y2="100%"><stop offset="0%" stopColor="#8b5cf6" /><stop offset="100%" stopColor="#6366f1" /></linearGradient>
            <linearGradient id="line1" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="transparent" /><stop offset="20%" stopColor="#6366f1" /><stop offset="50%" stopColor="#a855f7" /><stop offset="80%" stopColor="#6366f1" /><stop offset="100%" stopColor="transparent" /></linearGradient>
          </defs>
        </svg>
      </motion.div>

      {/* Layer 2 — Geometric shapes */}
      <motion.div style={{ y: y2, opacity: opacity2, rotate: rotate1 }} className="absolute inset-0 will-change-transform">
        <svg viewBox="0 0 1440 900" fill="none" className="w-full h-full" preserveAspectRatio="xMidYMid slice">
      ...
      {/* Layer 3 — DNA helix */}
      <motion.div style={{ y: y3, opacity: opacity3, rotate: rotate2 }} className="absolute inset-0 will-change-transform">
        <svg viewBox="0 0 1440 900" fill="none" className="w-full h-full" preserveAspectRatio="xMidYMid slice">
          ...
          <defs>
            <linearGradient id="dna1" x1="80" y1="0" x2="80" y2="1100" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#6366f1" /><stop offset="50%" stopColor="#a855f7" /><stop offset="100%" stopColor="#6366f1" /></linearGradient>
            <linearGradient id="dna2" x1="1300" y1="-100" x2="1300" y2="1000" gradientUnits="userSpaceOnUse"><stop offset="0%" stopColor="#a855f7" /><stop offset="50%" stopColor="#6366f1" /><stop offset="100%" stopColor="#a855f7" /></linearGradient>
          </defs>
        </svg>
      </motion.div>

      {/* Layer 4 — Dotted arcs */}
      <motion.div style={{ y: y4, rotate: rotate3, scale: scale2, opacity: opacity4 }} className="absolute inset-0 will-change-transform">
        <svg viewBox="0 0 1440 900" fill="none" className="w-full h-full" preserveAspectRatio="xMidYMid slice">
